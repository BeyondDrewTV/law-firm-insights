          ...
          <div className="h-1.5 w-full overflow-hidden rounded-full bg-neutral-200">
            <div
              className={[
                ...
                atCap ? "bg-red-500" : nearCap ? "bg-amber-500" : "bg-emerald-500",
              ].join(" ")}
              style={{ width: `${pct}%` }}
            />
          </div>

          {resetLabel ? <p className="text-[11px] text-neutral-500">Resets on {resetLabel}</p> : null}
        </div>
      ) : (
        <div className="rounded border border-neutral-200 bg-white px-3 py-2 text-xs text-neutral-700">
      ...
      {nearCap ? (
        <div className="flex items-start gap-2 rounded border border-amber-200 bg-amber-50 px-3 py-2.5">
          ...
          <div className="min-w-0">
            <p className="text-xs font-semibold text-amber-900">You're near your monthly limit.</p>
